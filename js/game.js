        ...
        for(var j=0;j<size;j++){
            for(var k=0;k<4;k++)
            {
                ...
                if(cells[size*i+j].walls[k] == true){
                    ...
                    {
                        // longwall 
                        var wall = new THREE.Mesh(new THREE.CubeGeometry(20,20,10), new THREE.MeshPhongMaterial({color: 0x227711}));
                        wall.position.set( posx + wallPos[k][0], 5, posz + wallPos[k][1]);
                        scene.add(wall);objects.push(wall)
                        // shortwall
                        var wall = new THREE.Mesh(new THREE.CubeGeometry(10,20,10), new THREE.MeshPhongMaterial({color: 0x227711}));
                        if (k == 0)
                        {
                    ...
                    {
                        //longwall
                        var wall = new THREE.Mesh(new THREE.CubeGeometry(10,20,20), new THREE.MeshPhongMaterial({color: 0x227711}));
                        wall.position.set( posx + wallPos[k][0], 5, posz + wallPos[k][1]);
                        scene.add(wall);objects.push(wall);
                        // shortwall
                        var wall = new THREE.Mesh(new THREE.CubeGeometry(10,20,10), new THREE.MeshPhongMaterial({color: 0x227711}));
